var app = {
  initialize: function(){
    ...
    this.options = {
      ...
      title: '你想走哪一条？那一条将透露出你内心性格！',
      desc: "静下心来选出图中你最想走的开始旅途的一条林间小路，它背后的答案就会完全解读出你目前的心理，也是准到跪！",
      link: "http://wx.hr72.com/20150918/index.html",
      imgUrl: "http://wx.hr72.com/20150918/logo.jpg"
    };
  ...
  result: function(char){
    ...
    section[3].querySelector('.e').style.display = 'none';
    section[3].querySelector('.f').style.display = 'none';

    section[3].querySelector('.' + char).style.display = 'block';
    section[3].querySelector('#aimg').src = char.charCodeAt() - 96 + '.jpg';
